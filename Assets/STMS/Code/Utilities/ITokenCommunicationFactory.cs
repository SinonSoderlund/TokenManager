...
namespace STMS.Tokens.TokenEntities.Communication.Factory
{
    ...
    public static class ITokenCommunicationsFactory<T> where T: class
    {
        ...
        public static TokenRequest<T> ModifyRequest(TokenRequest<T> _base, ITokenId? _receipient = null, ETokenCommands? _command = null, bool? _statusResponse = null, T? _payload = null)
        {
        ...
        /// <returns>merged data object</returns>
        public static TokenMessage ModifyMessage(TokenMessage _base, ITokenId? _receipient = null, ETokenCommands? _command = null, bool? _statusResponse = null, ITokenId? _sender = null)
        {
        ...
        /// <param name="_statusResponse">optional, new status value</param>
        /// <returns>merged data object</returns>
        public static TokenCommunication ModifyCommunication(TokenCommunication _base, ITokenId? _receipient = null, ETokenCommands? _command = null, bool? _statusResponse = null)
        {
        ...
        /// <param name="_sender">optional, new sender adress</param>
        /// <returns>merged data object</returns>
        public static TokenCarrier<T> ModifyCarrier(TokenCarrier<T> _base, ITokenId _receipient = null, ETokenCommands? _command = null, bool? _statusResponse = null, T? _payload = null,  ITokenId? _sender = null)
        {
        ...
        /// <param name="_statusResponse">optional, new status value</param>
        /// <returns>merged data object</returns>
        public static TokenMessage SenderReceiverSwapModifyMessage(TokenMessage _base, ETokenCommands? _command = null, bool? _statusResponse = null)
        {
        ...
        /// <param name="_payload">optional, new payload data</param>
        /// <returns>merged data object</returns>
        public static TokenCarrier<T> SenderReceiverSwapModifyCarrier(TokenCarrier<T> _base, ETokenCommands? _command = null, bool? _statusResponse = null, T? _payload = null)
        {
        ...
        /// <param name="_payload">optional, new payload data</param>
        /// <returns>merged data object</returns>
        public static TokenCarrier<T> SenderReceiverSwapReturnCarrier(ITokenCommunication _base, ETokenCommands? _command = null, bool? _statusResponse = null, T? _payload = null)
        {
        ...
        private static TokenCarrier<T> CommunicationToCarrier(ITokenCommunication _base, ITokenId _receipient = null, ETokenCommands? _command = null, bool? _statusResponse = null, T? _payload = null,  ITokenId? _sender = null)
        {
        ...
        /// <param name="_statusResponse">optional, new status value</param>
        /// <returns>merged data object</returns>
        public static TokenMessage SenderReceiverSwapReturnMessage(ITokenCommunication _base, ETokenCommands? _command = null, bool? _statusResponse = null)
        {
